...
//	TAGKEYS(			XK_9,          8)
	...
	//{ MODKEY,			            XK_h,          spawn,                  SHCMD("~/dotfiles/.scripts/xleft.sh") },
	{ MODKEY,			            XK_j,          spawn,                  SHCMD("~/dotfiles/.scripts/xdown.sh") },
	{ MODKEY|ShiftMask,		        XK_w,          spawn,                  SHCMD("~/dotfiles/.scripts/set_wallpaper.sh") },
	//{ MODKEY,			            XK_k,          spawn,                  SHCMD("~/dotfiles/.scripts/xup.sh") },
	//{ MODKEY,			            XK_l,          spawn,                  SHCMD("~/dotfiles/.scripts/xright.sh") },
